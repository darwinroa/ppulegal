...
//   if ($query->have_posts()) {
//     $html = '
//             <div id="mdw__lawyer_post-slider" class="">
...
//                 <!-- Agregar paginación si lo deseas -->
...
function lawyer_posts_function()
{
  ...
  //   function enqueue_swiper_manually() {
  // }
  // add_action('wp_enqueue_scripts', 'enqueue_swiper_manually');
